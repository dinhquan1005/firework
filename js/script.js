...
// Tạo bản đồ điểm (dots map) cho các từ
const wordDotsMap = {};

// Lặp qua từng từ để ánh xạ thành lưới điểm
randomWords.forEach((word) => {
  wordDotsMap[word] = MyMath.literalLattice(
    word, // Từ cần xử lý
    10, // Mật độ điểm (càng cao, điểm càng dày)
    "Gabriola,华文琥珀", // Phông chữ
    "90px" // Kích thước chữ
  );
});

// Hiển thị kết quả trong bảng điều khiển để kiểm tra
console.log(wordDotsMap);
...
const helpContent = {
  shellType: {
    ...
    body: "Chọn loại pháo hoa bạn muốn bắn. Lựa chọn 'Ngẫu nhiên' có thể mang lại trải nghiệm thú vị!",
  },
  shellSize: {
    header: "Kích thước pháo hoa",
    body: "Pháo hoa càng lớn thì phạm vi nổ càng rộng, nhưng pháo hoa lớn cũng yêu cầu hiệu năng thiết bị cao hơn. Pháo hoa lớn có thể gây lag cho thiết bị của bạn.",
  },
  quality: {
    header: "Chất lượng hình ảnh",
    body: "Nếu hoạt ảnh không mượt mà, bạn có thể thử giảm chất lượng. Chất lượng càng cao, tia lửa càng nhiều, nhưng cũng có thể làm thiết bị chậm hơn.",
  },
  skyLighting: {
    header: "Chiếu sáng bầu trời",
    body: "Khi pháo hoa nổ, nền sẽ sáng lên. Nếu màn hình quá sáng, bạn có thể chuyển sang chế độ 'Tối' hoặc 'Tắt'.",
  },
  scaleFactor: {
    header: "Thu phóng",
    body: "Đưa bạn lại gần hoặc xa hơn pháo hoa. Với pháo hoa lớn, bạn có thể chọn giá trị thu phóng nhỏ hơn, đặc biệt trên điện thoại hoặc máy tính bảng.",
  },
  wordShell: {
    header: "Pháo hoa chữ",
    body: "Bật tùy chọn này để tạo pháo hoa theo hình dạng chữ, ví dụ: 'Chúc mừng năm mới', 'Vạn sự như ý', v.v.",
  },
  autoLaunch: {
    header: "Tự động bắn pháo hoa",
    body: "Bật tùy chọn này để thưởng thức pháo hoa tự động mà không cần thao tác. Nếu tắt, bạn cần nhấn vào màn hình để bắn pháo hoa.",
  },
  finaleMode: {
    header: "Bắn nhiều pháo hoa cùng lúc",
    body: "Tùy chọn này cho phép bắn nhiều pháo hoa đồng thời (cần bật 'Tự động bắn pháo hoa' trước).",
  },
  hideControls: {
    header: "Ẩn các nút điều khiển",
    body: "Ẩn các nút trên đầu màn hình. Tùy chọn này hữu ích khi chụp ảnh màn hình hoặc tạo trải nghiệm liền mạch. Bạn vẫn có thể mở cài đặt từ góc trên bên phải.",
  },
  fullscreen: {
  ...
  longExposure: {
    header: "Lưu lại tia lửa pháo hoa",
    body: "Tùy chọn này giúp lưu lại các tia lửa pháo hoa trên màn hình.",
  },
};
...
function init() {
  ...
  setOptionsForSelect(appNodes.skyLighting, [
    ...
    { label: "Sáng", value: SKY_LIGHT_NORMAL },
  ]);
...
class Shell {
  ...
  burst(x, y) {
    ...
    if (typeof this.color === "string") {
      ...
      throw new Error(
        "Màu pháo hoa không hợp lệ. Dự kiến ​​một chuỗi hoặc mảng chuỗi nhưng đã nhận được:" +
          this.color
      );
    }
...
if (IS_HEADER) {
  ...
  setLoadingStatus("Đang khởi động");
  setTimeout(() => {
    //soundManager
